            ...
            this.questions = [
                {
                    ...
                    "options": [
                        "Είναι μια λίστα με τα 10 πιο κρίσιμα εργαλεία ασφάλειας για τον δημόσιο τομέα",
                        ...
                        "Είναι μια λίστα με τους 10 καλύτερους προγραμματιστές ασφάλειας",
                        "Είναι μια λίστα με τα 10 πιο ασφαλή λειτουργικά συστήματα"
                    ],
                    "correct_answer": 1,
                ...
                },
                {
                    ...
                    "options": [
                        "Η ανεπαρκής κρυπτογράφηση που επιτρέπει την υποκλοπή δεδομένων",
                        ...
                        "Η έλλειψη ενημερώσεων λογισμικού που οδηγεί σε επιθέσεις",
                        "Η χρήση αδύναμων κωδικών πρόσβασης από τους χρήστες"
                    ],
                    "correct_answer": 1,
                ...
                },
                {
                    ...
                    "options": [
                        "Είναι η αποτυχία να δημιουργηθεί αντίγραφο ασφαλείας των δεδομένων",
                        ...
                        "Είναι η αποτυχία να διαγραφούν παλιά δεδομένα",
                        "Είναι η αποτυχία να ενημερωθεί το λογισμικό"
                    ],
                    "correct_answer": 1,
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "Η αυθεντικοποίηση αφορά μόνο τους διαχειριστές",
                        "Η εξουσιοδότηση αφορά μόνο τους χρήστες"
                    ],
                    "correct_answer": 1,
                ...
                },
                {
                    ...
                    "options": [
                        "Είναι η χρήση μόνο βιομετρικών στοιχείων",
                        ...
                        "Είναι η χρήση μόνο κωδικού πρόσβασης",
                        "Είναι η χρήση μόνο κινητού τηλεφώνου"
                    ],
                    "correct_answer": 1,
                ...
                },
                {
                    ...
                    "options": [
                        "Για να φορτώνει πιο γρήγορα η σελίδα",
                        ...
                        "Για να φαίνεται πιο επαγγελματική η σελίδα",
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "Μόνο η διαφάνεια",
                        "Μόνο η ελαχιστοποίηση δεδομένων",
                        "Μόνο η ακρίβεια"
                    ],
                    "correct_answer": 0,
                ...
                },
                {
                    ...
                    "options": [
                        "Η προστασία των προσωπικών δεδομένων πρέπει να ενσωματώνεται στον πυρήνα του σχεδιασμού από την αρχική σύλληψη της εφαρμογής",
                        "Η προστασία των δεδομένων γίνεται μόνο μετά την υλοποίηση",
                        "Η προστασία των δεδομένων αφορά μόνο τους διαχειριστές",
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "Μόνο στατικοί έλεγχοι",
                        "Μόνο δυναμικοί έλεγχοι",
                        "Μόνο έλεγχοι διείσδυσης"
                    ],
                    "correct_answer": 0,
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "Μόνο εκτίμηση πιθανότητας",
                        "Μόνο αναγνώριση απειλών",
                        "Μόνο καθορισμό προτεραιοτήτων"
                    ],
                    "correct_answer": 0,
                ...
                },
                {
                    ...
                    "options": [
                        "Στα ευρήματα χαμηλού κινδύνου",
                        "Στα ευρήματα που δεν μπορούν να εκμεταλλευτούν εύκολα",
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "Μόνο ιδιόκτητες υποδομές",
                        "Μόνο δημόσιο cloud",
                        "Μόνο κυβερνητικό cloud"
                    ],
                    "correct_answer": 0,
                ...
                },
                {
                    ...
                    "options": [
                        "Είναι αυτοματοποιημένες διαδικασίες ανάπτυξης που μειώνουν τα ανθρώπινα λάθη και επιτρέπουν συχνές αλλά ελεγχόμενες ενημερώσεις",
                        "Είναι μόνο για δοκιμές",
                        "Είναι μόνο για μεγάλα έργα",
                        "Δεν είναι σημαντικό"
                    ],
                    "correct_answer": 0,
                ...
                },
                {
                    ...
                    "options": [
                        "Γιατί κάνει την εφαρμογή πιο περίπλοκη",
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "Για να φαίνεται πιο επαγγελματικό το έργο",
                ...
                },
                {
                    ...
                    "options": [
                        "Άμεση εφαρμογή αλλαγών στο production χωρίς δοκιμή",
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        "Μόνο συμμετοχή προγραμματιστών",
                        "Μόνο καθορισμός απαιτήσεων στο τέλος",
                ...
                },
                {
                    ...
                    "options": [
                        "Η αύξηση του κόστους ανάπτυξης",
                        ...
                        "Η μείωση της λειτουργικότητας",
                        "Η πολυπλοκότητα στη χρήση"
                    ],
                    "correct_answer": 1,
